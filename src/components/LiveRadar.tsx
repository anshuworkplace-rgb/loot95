  ...
  return (
    <div className="deal-feed">
      <div className="feed-header">
        <div>
          <h2>100% LIVE AMAZON INDIA DEAL RADAR</h2>
          <span style={{ fontSize: '0.75rem', color: 'var(--loot-green)' }}>
            Direct Amazon.in Intelligence • All-Time Lows & Real Prices • Real-time SSE Stream
          </span>
        </div>
